...
public class CommodityPlantProductsServiceTest {
  ...
  @InjectMocks private CommodityPlantProductsService commodityPlantProductsService;
  ...
  private CommodityPlantProducts TEST_COMMODITY_PLANT_PRODUCTS_FOR_UPDATE =
      TEST_COMMODITY_PLANT_PRODUCTS.toBuilder().build();
  ...
  public void testGetCommoditiesByConsignmentId() {
    ...
    List<Commodity> testCommodityPlantProducts = List.of(TEST_COMMODITY_PLANT_PRODUCTS_FOR_UPDATE);
    ...
    when(commodityBotanicalMapper.asCommodityPlantProductsList(testPersistentCommodityBotanical))
        .thenReturn(testCommodityPlantProducts);

    List<Commodity> actual =
        commodityPlantProductsService.getCommoditiesByConsignmentId(consignmentId);

    assertEquals(testCommodityPlantProducts, actual);

    verify(commodityBotanicalRepository)
        .getCommoditiesByConsignmentId(commodityBotanicalDAO, consignmentId);
    verify(commodityBotanicalMapper).asCommodityPlantProductsList(testPersistentCommodityBotanical);
  }
  ...
  public void testInsertCommodities() {
    ...
    when(commodityBotanicalMapper.asPersistentCommodityBotanical(
            paf.getPersistentConsignments().get(0).getId(), TEST_COMMODITY_PLANT_PRODUCTS_FOR_UPDATE))
        .thenReturn(TEST_PERSISTENT_COMMODITY_BOTANICAL);

    // ACT
    commodityPlantProductsService.insertCommodities(
        singletonList(TEST_COMMODITY_PLANT_PRODUCTS_FOR_UPDATE),
    ...
    // ASSERT
    assertEquals(
        insertedPersistentCommodityBotanical.get(0).getGenus(),
        TEST_COMMODITY_PLANT_PRODUCTS_FOR_UPDATE.getGenus());
    assertEquals(
        insertedPersistentCommodityBotanical.get(0).getSpecies(),
        TEST_COMMODITY_PLANT_PRODUCTS_FOR_UPDATE.getSpecies());
    assertEquals(
        insertedPersistentCommodityBotanical.get(0).getDistinguishingMarks(),
        TEST_COMMODITY_PLANT_PRODUCTS_FOR_UPDATE.getDistinguishingMarks());
  ...
  public void testDeleteCommodityByUUID() {
    TEST_COMMODITY_PLANT_PRODUCTS_FOR_UPDATE.setCommodityUuid(commodityUUID);

    commodityPlantProductsService.deleteCommodity(TEST_COMMODITY_PLANT_PRODUCTS_FOR_UPDATE.getCommodityUuid());
  ...
  public void testUpdateQuantityPassed() {
    commodityPlantProductsService.updateQuantityPassed(TEST_COMMODITY_PLANT_PRODUCTS_FOR_UPDATE, 0.5);
    assertTrue(TEST_COMMODITY_PLANT_PRODUCTS_FOR_UPDATE.getQuantityOrWeightPerPackage().equals(0.5));
  }
  ...
  public void testUpdateCommodity() {
    ...
    commodityPlantProductsService.updateCommodity(
        commodityUUID, TEST_COMMODITY_PLANT_PRODUCTS_FOR_UPDATE, handle);
    ...
    assertEquals(
        TEST_COMMODITY_PLANT_PRODUCTS_FOR_UPDATE.getCommodityUuid(),
  ...
  public void testCloneCommodities() {
    ...
    commodityPlantProductsService.cloneCommodities(handle, consignmentId, newConsignmentId);
