...
public class CertificateSerialNumberPopulator implements ApplicationFormFieldPopulator {
  ...
  public void populate(
    ...
    fields.put(
        TemplateFieldConstants.CERTIFICATE_SERIAL_NUMBER, String.valueOf(applicationForm.getId()));
  }
}
