...
@Documented
@Constraint(validatedBy = {PrimaryDestinationDataValidator.class})
@Target(PARAMETER)
@Retention(RUNTIME)
public @interface PrimaryDestinationDataValid {
  String message() default "Invalid primary destination";
